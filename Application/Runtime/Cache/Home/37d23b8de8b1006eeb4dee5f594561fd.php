        ...
        <div class="modal-content allcont">
            ...
            <form class="form-signup">
                ...
                <div class="row">
                    ...
                    <img src="/index.php/Home/Article/captcha" class="code_img" onclick="this.src='/index.php/Home/Article/captcha/'+Math.random()">
...
<div class="col-xs-6 col-sm-4 left" >
	...
	<div class="list-group">
		<?php if(is_array($hotart)): $i = 0; $__LIST__ = $hotart;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li href="#" class="list-group-item "><a href="<?php echo U('Article/showArt',array('art_id'=>$row['art_id']));?>"><span class="glyphicon glyphicon-list"></span><?php echo (substr($row["title"],0,45)); ?>...</a><span class="badge">hot！！</span></li><?php endforeach; endif; else: echo "" ;endif; ?>
