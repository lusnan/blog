...
<!--head头部开始-->
    ...
    <title>博客--<?php echo ($catename); ?></title>
...
<div class="col-xs-6 col-sm-4 left" >
	...
	<div class="list-group">
		<?php if(is_array($hotart)): $i = 0; $__LIST__ = $hotart;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li href="#" class="list-group-item ">
			<a href="<?php echo U('Article/showArt',array('art_id'=>$row['art_id']));?>"><p><span class="glyphicon glyphicon-list"></span><?php echo (substr($row["title"],0,41)); ?></p>...</a>
...
<!-- 通用左侧列表结束 -->
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Index/category',array('cate_id'=>$row['cate_id']));?>"><?php echo ($catename); ?></a></li>
    </ol>
  ...
  <?php if(is_array($artinfos)): $i = 0; $__LIST__ = $artinfos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rows): $mod = ($i % 2 );++$i;?><div class="jumbotron ">
    <div class="row ">
      <div class="col-md-8 jumtop">
        <div class='arttitle'>
          <a href="<?php echo U('Article/showArt',array('art_id'=>$rows['art_id']));?>"><span class="glyphicon glyphicon-triangle-right"></span><?php echo ($rows["title"]); ?></a>
          
        </div>   
        <div><span><?php echo ($rows["art_desc"]); ?></span></div>        
      </div>
      <div class="col-md-4 thumb" ><img src="<?php echo ($rows["thumbpath"]); ?>" alt="thumb"></div>
    </div>  
    <div class="row jumtopbb">
        <div class="col-md-2 col-md-offset-6 forallc" ><a href="<?php echo U('Article/showArt',array('art_id'=>$rows['art_id']));?>">查看全文</a></div>
    </div>
    <div class="row bottom">
      <div class="col-md-4 author"><span class="glyphicon glyphicon-user" ></span><?php echo ($rows["author"]); ?></div>
      <div class="col-md-4 riqi"><span class="glyphicon glyphicon-calendar" ></span><?php echo ($rows["addtime"]); ?></div>
      <div class="col-md-2 "><span class="glyphicon glyphicon-align-center" ></span><span class="cate_id"><?php echo ($rows["cate_id"]); ?></span></div>
      <div class="col-md-2 zan" id='<?php echo ($rows["art_id"]); ?>'><span class="glyphicon glyphicon-thumbs-up" ></span><span class="zan_num"><?php echo ($rows["likes"]); ?></span></div>
      
    </div>
  </div><?php endforeach; endif; else: echo "" ;endif; ?>
  
  <ul class="pagination pagination-lg " style="margin-left: 220px">
    <?php echo ($showpage); ?>
  </ul>
