  ...
  <div class="tab">
    ...
    <div class="tab-body"> <br/>
      <div class="tab-panel active" id="tab-set">
        <form method="POST" class="form-x" action="<?php echo U('Category/edit');?>">
          <div class="form-group">
            <div class="label">
              <label for="sitename">分类名称</label>
            </div>
            <div class="field">
              <input type="text" class="input" id="name" name="cate_name" size="50" placeholder="分类名称" data-validate="required:请填写您的分类名称" value="<?php echo ($cateinfobyid["cate_name"]); ?>" />
            </div>
          </div>
          <div class="form-group">
            <div class="label">
          ...
          <div class="form-button">
            <input type="hidden" name="cate_id" value='<?php echo ($cateinfobyid["cate_id"]); ?>'>
