  ...
  <div class="tab">
    ...
    <div class="tab-body"> <br />
      <div class="tab-panel active" id="tab-set">
        <form method="POST" class="form-x" action="<?php echo U('Article/edit');?>" enctype="multipart/form-data">
          <div class="form-group">
            <div class="label">
              <label for="sitename">文章标题</label>
            </div>
            <div class="field">
              <input type="text" class="input" id="title" name="title" size="50" placeholder="文章标题" data-validate="required:请填写您的文章标题" value="<?php echo ($artinfobyid["title"]); ?>" />
            </div>
          </div>
          <div class="form-group">
            <div class="label">
            ...
            <div class="field"> <a class="button input-file" href="javascript:void(0);">上传文件
              ...
              <input type="hidden" name="thumb_bak" value="<?php echo ($artinfobyid["thumb"]); ?>">
              </a> </div>
          </div>
          <div class="form-group">
            <div class="label">
            ...
            <div class="field">
              <input type="text" class="input" id="author" name="author" size="50" placeholder="请填写文章作者" data-validate="required:请填写文章作者" value="<?php echo ($artinfobyid["author"]); ?>" />
            </div>
          </div>
          <div class="form-group">
            <div class="label">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea name="art_desc" class="input" rows="2" cols="50" placeholder="请填写文章描述" data-validate="required:请填写文章描述"><?php echo ($artinfobyid["art_desc"]); ?></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="label">
            ...
            <div class="field">
              <textarea name="content" id="ckeditor" class="input" rows="8" cols="50" placeholder="请填写文章内容" data-validate="required:请填写文章内容"><?php echo ($artinfobyid["content"]); ?></textarea>
          ...
          <div class="form-button">
            <input type="hidden" name="art_id" value="<?php echo ($artinfobyid["art_id"]); ?>">
